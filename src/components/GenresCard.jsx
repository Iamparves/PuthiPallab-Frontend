...
const GenresCard = ({ genre }) => {
  ...
  return (
    <Link
      ...
      className="group relative block aspect-[2/1.1] min-h-[100px] w-full overflow-hidden rounded-md"
    >
      <img
      ...
      <div className="absolute left-0 top-0 flex h-full w-full items-center justify-center bg-black/60 p-5 duration-300 hover:backdrop-blur-[2px]">
        <p className="text-center font-semibold leading-tight tracking-wide text-white duration-300 group-hover:tracking-widest">
          {genreName}
        </p>
      </div>
    </Link>
